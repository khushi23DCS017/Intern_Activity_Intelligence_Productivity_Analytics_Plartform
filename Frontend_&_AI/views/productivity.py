...
def render():
    ...
    # Filter data based on role if necessary (for demo, Manager sees all or maybe just a subset)
    # Here we show all for simplicity, but in a real app would filter by Manager_ID or Mentor_ID
